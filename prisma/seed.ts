...
async function main() {
  let freeFire = await prisma.category.findFirst({
  ...
  let valorant = await prisma.category.findFirst({
    where: { name: "Valorant" },
  });
  if (!valorant)
  ...
  let cod = await prisma.category.findFirst({
  ...
  let bloodstrike = await prisma.category.findFirst({
    where: { name: "Bloodstrike" },
  });
  if (!bloodstrike)
    bloodstrike = await prisma.category.create({
      data: {
        name: "Bloodstrike",
        image: "/images/categories/bloodstrike.jpg",
      },
    });

  let freeProducts = await prisma.category.findFirst({
    where: { name: "Free Products" },
  });
  if (!freeProducts)
  ...
  const allProducts = [
    ...
    },
    {
      ...
      data: {
        name: "Panel Secure",
        description:
          "Panel basico con las funciones esenciales para Free Fire Emulador",
        features: [
          "Aimbots external",
          "Chams",
          "Fix Lag",
    ...
    },
    {
      ...
      data: {
        name: "Bypass Free",
        description:
          "Versión gratuita del Bypass — 3 días de prueba. Contacta soporte en Discord para recibir tu key.",
        features: [
          "Indetectable",
          "Activacion Rapida",
          "Sin riesgo de black/ban",
          "Prueba gratuita por 3 días",
          "Key entregada por Discord",
        ],
        isBest: false,
        status: "UNDETECTED",
    ...
    },
    {
      ...
      data: {
        ...
        plans: [{ label: "Por Temporada", price: 39.99 }],
      },
    },
    {
      category: freeFire,
    ...
    },
    {
      ...
      data: {
        ...
        plans: [{ label: "Por Temporada", price: 64.99 }],
      },
    },
    {
      category: freeFire,
    ...
    },
    {
      ...
      data: {
        ...
        plans: [{ label: "A consultar", price: 0 }],
      },
    },
    {
      category: valorant,
      data: {
        ...
        status: "UNDETECTED",
        images: ["/spoofer.png"],
        plans: [{ label: "Permanente", price: 49.99 }],
      },
    },
    {
      category: csgo,
    ...
    },
    {
      ...
      data: {
        ...
        features: [
          "Aimbot: Head/Neck/Assist/Cycle/Silent/AimKill",
          "ESP: Line/Box/Name/Skeleton/Health",
          "Misc: NoRecoil/BackJump/InvertedWall",
        ],
        isBest: false,
        status: "UNDETECTED",
    ...
    },
    {
      ...
      data: {
        ...
        features: [
          "Chams: 3D/Glow/Solido/Wireframe/RGB",
          "ESP completo",
          "Stream Spoof",
          "HVCI ON & OFF",
          "Windows 8/10/11",
