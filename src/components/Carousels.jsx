...
const platformItems = [
  {
    label: "PC",
    icon: <Monitor size={13} className="text-white/30" />,
  },
  {
    label: "iOS",
    icon: <Smartphone size={13} className="text-white/30" />,
  },
  {
    label: "Android",
    icon: <TabletSmartphone size={13} className="text-white/30" />,
  },
];
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-10">
          <a
            ...
            style={{
              ...
              boxShadow:
                "0 0 25px rgba(6, 182, 212, 0.5), 0 0 50px rgba(6, 182, 212, 0.2)",
            }}
          >
            {hero?.cta}
            <svg
