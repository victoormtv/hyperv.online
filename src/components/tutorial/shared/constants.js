import {
  Shield, Settings, MessageCircle, Crosshair, Smartphone,
  Zap, Code2, Swords, Eye, Lock, Wifi, ScanLine, Target, Layers
} from "lucide-react";
...
export const BYPASS_PRODUCTS = ["bypass-apk", "bypass-uid-bluestacks", "bypass-uid-memuplay"];

export const PRODUCT_CONFIG = {
  "panel-full":        { loaderUrl: "https://www.realhostx.com/Cloud/tanatozn/HyperV (1).exe", videoUrl: "https://www.youtube.com/embed/jFsVHEAIYco" },
  "panel-secure":      { loaderUrl: "https://www.realhostx.com/Cloud/tanatozn/HyperV (1).exe", videoUrl: "https://www.youtube.com/embed/TFYhmK790_E" },
...
export const LINKS = {
  ...
  ultraviewer: "https://www.realhostx.com/Cloud/tanatozn/UltraViewer_setup_6.6.124_es.exe",
  anydesk:     "https://www.realhostx.com/Cloud/tanatozn/AnyDesk.exe",
  warp:        "https://one.one.one.one/",
  warpBypass:  "https://www.realhostx.com/Cloud/tanatozn/CloudflareWARP2025.10.186.0.msi",
  ...
  ffNormalApk: "https://1drv.ms/u/c/d5b038515b00d0eb/IQDqHrlc4s17T7_M6gser5-yAZyHI-v0ZF9aE7Su6lO7bMs?e=GDyHKW",
  ffMaxApk:    "https://1drv.ms/u/c/d5b038515b00d0eb/IQCQ-jI398jZQ6Qw4ieeTpGMAcVOQx0NT0HZveAghmgETHo?e=zzCxnk",
