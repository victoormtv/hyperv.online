...
import { ACCENT, LINKS, PRODUCT_CONFIG, getGroupIssues } from "../shared/constants";
...
export default function PanelBase({ section, productName, productId, tx }) {
  const cfg = PRODUCT_CONFIG[productId];

  if (section === "general-dependencies")
    return <SectionGeneralDependencies tx={tx} />;
  ...
  return <SectionCommonIssues tx={tx} issues={getGroupIssues(productId)} />;
}
