  ...
  const contactRow = contactLabel
    ...
    <tr>
      <td style="padding:14px 18px;border-bottom:1px solid rgba(255,255,255,0.05);color:#fff;">
        ...
        <span style="color:#06b6d4;margin-left:6px;">${contactLabel}</span>
      </td>
    </tr>
  `
    : "";
  ...
  const licenseRow = licenseKey
    ...
    <tr>
      <td style="padding:14px 18px;border-bottom:1px solid rgba(255,255,255,0.05);color:#fff;">
        ...
        <span style="display:block;margin-top:6px;color:#06b6d4;font-family:'Courier New',monospace;font-size:13px;word-break:break-all;background:rgba(6,182,212,0.08);padding:8px 12px;border-radius:8px;border:1px dashed rgba(6,182,212,0.3);">${licenseKey}</span>
      </td>
    </tr>
  `
    : `
    <tr>
      <td style="padding:14px 18px;border-bottom:1px solid rgba(255,255,255,0.05);color:#fff;">
        <strong>License Key:</strong>
        <span style="color:rgba(255,165,0,0.8);margin-left:6px;">⚠ Entrega manual pendiente</span>
      </td>
    </tr>
  `;
