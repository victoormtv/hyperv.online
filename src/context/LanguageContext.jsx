  ...
  en: {
    ...
    termsPage: {
      ...
      sections: [
        ...
        { n: "3", title: "Payment & Pricing", intro: "All payments are processed securely through our payment providers. By making a purchase, you acknowledge that:", items: ["Prices are listed in USD or PEN and may change without notice","Payment must be completed before product activation","Disputing or reversing payments will result in immediate account suspension","We reserve the right to refuse service to anyone for any reason"] },
    ...
    tutorial: {
      ...
      dl: {
        ...
        rootTittle: "Root Checker",
        rootDesc: "Download the Root Checker version compatible with your emulator.",
        ffDesc: "Download the Free Fire version compatible with your emulator.",
        zArchiverTitle: "ZArchiver",
        zArchiverDesc: "Download ZArchiver to extract the files.",
  ...
  es: {
    ...
    tutorial: {
      ...
      dl: {
        ...
        rootTittle: "Root Checker",
        rootDesc: "Descarga el Root Checker para verificar si tu emulador tiene root.",
        emuTitle: "Emuladores Compatibles",
        zArchiverTitle: "ZArchiver",
        zArchiverDesc: "Descarga ZArchiver para extraer los archivos.",
